...
\begin{table}[H]
    ...
    \begin{tabular}{lccccc}
        ...
        \midrule
        Random Forest & 0.6727 & 0.6729 & 0.7912 & \textbf{0.7273} & \textbf{0.7344} \\
...
Os modelos baseados em árvores de decisão (Random Forest, XGBoost, LightGBM) apresentaram o melhor desempenho geral. O \textbf{Random Forest} foi o campeão, com o maior F1-Score (0.7273) e ROC-AUC (0.7344). Isso sugere que a capacidade do Random Forest de reduzir a variância através do \textit{bagging} e da aleatorização de \textit{features} é particularmente eficaz para este tipo de dados, que pode conter ruído e relações não-lineares complexas.
...
\begin{table}[H]
    ...
    \begin{tabular}{llll}
        ...
        \textbf{Este trabalho} & Classificação & Random Forest & F1-Score = 0.727 \\
        \bottomrule
    \end{tabular}
\end{table}
